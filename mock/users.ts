...
export const register = (req: Request, res: Response) => res.json({
		code: 20000
	})
...
export const logout = (req: Request, res: Response) => res.json({
		code: 20000
	})
...
export const deleteUser = (req: Request, res: Response) => res.json({
		code: 20000
	})
