	...
	<view :style="{width: fullWidth, color: defaultColor}" style="position: relative;padding-bottom: 20px" class="bg-white">
		<view class="full-width">
			<scroll-view :scroll-left="tabLeft" scroll-with-animation scroll-x="true" scroll-y style="display: flex;text-align: center">
				<view :data-index="index" :id="'id'+index" :key="index" :style="{color: index===myTab ? 'white' : '#3577FE',
				width: '20%', backgroundColor: index===myTab ? '#5698FE' : '#fff',
					  ...
					  style="border-radius: 22px;box-shadow: 0px 3px 3px 0px #C6D6EF;margin-left: 10px;" v-for="(item,index) in tabListsNew">
