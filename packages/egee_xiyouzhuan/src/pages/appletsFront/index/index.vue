						...
						<view style="background: rgb(251, 207, 36);">
							<view class="flex justify-between text-center" style="padding-bottom: 100rpx">
								...
								<view class="margin-top flex flex-wrap justify-center margin-right" @tap="$mio.mioRoot.push('/pages/appletsFront/module/addItem')"
									...
									<view style="width: 20vw;margin-top: -30rpx;" class="text-black">添加标题</view>
								</view>
							</view>
				...
				<view class="text-center margin-top">
					...
					<view class="flex justify-around margin-top">
						<m-button :hairLine="true" :loading="false" :plain="false" :ripple="true" :disabled="false"
								  ...
								  @tap="replace" class="text-white" :customStyle="{fontSize: '14px', background: '#FB5B55;'}">
							<view class="fa text-xl fa-android margin-right-xxl" style="height: 50rpx" v-if="false"></view>
							换一批
						</m-button>
						<m-button :hairLine="true" :loading="false" :plain="false" :ripple="true" :disabled="false"
								  :shape="['square', 'circle'][1]" :size="['default', 'medium', 'mini'][1]"
								  :type="['default', 'primary', 'error', 'warning', 'success'][2]"
								  @tap="modalWx" class="text-white" :customStyle="{fontSize: '14px', background: '#FB5B55;'}">
							<view class="fa text-xl fa-android margin-right-xxl" style="height: 50rpx" v-if="false"></view>
							复制并打开微信
						</m-button>
					</view>
