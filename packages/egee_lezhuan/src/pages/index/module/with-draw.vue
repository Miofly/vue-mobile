<template>
	<view class="bg-white">
		...
		<view class="flex text-center flex-wrap justify-around margin-top-ten">
			<view v-for="(item, index) in lists" :key="index" style="width: 200rpx;height: 180rpx" class="text-center">
		...
		<view>
			<view v-if="false" class="flex justify-around align-center margin-top-xl">
