<template>
	<view>
		...
		<view class="bg-white center padding-xl border-radius width-ninety margin-top-ten">
			<view>
				...
				<view style="border-bottom: 1px solid rgba(0, 0, 0, 0.3)">
					...
					<input :adjust-position="false" v-model="regInfos.mobile" :focus="false" :password="false" placeholder="请输入手机号码"
			...
			<view class="margin-top-ten">
				...
				<view style="border-bottom: 1px solid rgba(0, 0, 0, 0.3)">
					...
					<input :adjust-position="false" v-model="regInfos.msgCode" :focus="false" :password="false" placeholder="请输入验证码"
			...
			<view class="margin-top-ten">
				...
				<view style="border-bottom: 1px solid rgba(0, 0, 0, 0.3)">
					...
					<input :adjust-position="false" v-model="regInfos.password" :focus="false" :password="true" placeholder="请输入6-20位密码"
			...
			<view class="margin-top-ten">
				...
				<view style="border-bottom: 1px solid rgba(0, 0, 0, 0.3)">
					...
					<input :adjust-position="false" v-model="regInfos.repassword" :focus="false" :password="true" placeholder="请再次输入密码"
						   maxlength="30" confirm-type="完成"/>
				</view>
			</view>
			...
			<view class="margin-top-ten">
				...
				<view style="border-bottom: 1px solid rgba(0, 0, 0, 0.3)">
					...
					<input :adjust-position="false" v-model="regInfos.realName" :focus="false" :password="false" placeholder="请输入真实姓名"
						   maxlength="30" confirm-type="完成"/>
				</view>
			</view>
			...
			<!--<view class="margin-top-ten">-->
				...
				<!--<view style="border-bottom: 1px solid rgba(0, 0, 0, 0.3)">-->
					...
					<!--<input :adjust-position="false" v-model="regInfos.ali_account" :focus="false" :password="false" placeholder="请输入支付宝账号"-->
						   <!--confirm-type="完成"/>-->
				<!--</view>-->
			<!--</view>-->
			<view class="margin-top-ten">
				<view class="fa fa-hand-o-right fl margin-right-xl text-red"
					  style="margin-top: -0.2rem;font-size: 50rpx;width: 1rem"></view>
				<view style="border-bottom: 1px solid rgba(0, 0, 0, 0.3)">
					<view v-show="regInfos.inviteCode" class="fa fa-close fr margin-right-lower"
						  @tap="delVals('inviteCode')"></view>
					<input :adjust-position="false" v-model="regInfos.inviteCode" :focus="false" :password="false" placeholder="请输入邀请码（必填）"
						   maxlength="5" confirm-type="完成"/>
				</view>
			</view>
