								...
								<view class="flex">
									...
									<button :class="[['bg-red', 'line-red', 'line-red lines-red'][0],
								        ['sm', 'lg', ''][0], false ? 'round' : '', true ? 'shadow' : '', false ? 'block' : '']"
											...
											style="margin-left: 10px;width: 180rpx">
										<text class="fa fa-wechat" style="padding-right: 10rpx" v-show="true"></text>
										<text class="text-df" style="width: 100rpx">qq图文</text>
									</button>
								</view>
								<view class="margin-top">
									<button :class="[['bg-red', 'line-red', 'line-red lines-red'][0],
								        ['sm', 'lg', ''][0], false ? 'round' : '', true ? 'shadow' : '', false ? 'block' : '']"
											...
											style="width: 180rpx">
										<text class="fa fa-wechat" style="padding-right: 10rpx" v-show="true"></text>
										<text class="text-df" style="width: 120rpx">uc图文</text>
									</button>
								</view>
							</view>
						</view>
            ...
            async jumpWxUc(title, desc, pic, id) {
                ...
                if (data.data == null) {
                    ...
                    if (navigator.userAgent.toLowerCase().indexOf('micromessenger') !== -1) {
                        this.ui.showToast('图文分享请打开QQ/UC浏览器，右上角选择QQ/UC浏览器')
