	...
	<view class="full-width-height">
		...
		<view class="cu-bar tabbar bg-white foot">
			<view @click="NavChange" class="action" :data-cur=pageOptions[0]>
				<view class="fa fa-home" :class="PageCur==pageOptions[0]?'text-red':'text-gray'"></view>
			...
			<view v-if="is_team_captain" @click="NavChange" class="action" :data-cur=pageOptions[2]>
				<view class="fa fa-gift" :class="PageCur==pageOptions[2]?'text-red':'text-gray'"></view>
			...
			<view @click="NavChange" class="action" :data-cur=pageOptions[3]>
				<view class="fa fa-user" :class="PageCur==pageOptions[3]?'text-red':'text-gray'"></view>
