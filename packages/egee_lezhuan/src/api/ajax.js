...
function ajax ({
    ...
    return new Promise((resolve, reject) => {
        ...
        //         console.log('这是拦截器', token)
        //
        //         config.headers.Authorization = `${token}`
        //         // config.headers.Authorization = store.state.TOKEN_KEY
        //
        ...
        //         }
        //         console.log('这是响应拦截器', response.data.data.token)
        //         console.log(store.state)
        //         store.state.TOKEN_KEY = response.data.data.token
