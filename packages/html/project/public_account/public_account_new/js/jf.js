...
(function() {
    ...
    hm.src = "https://hm.baidu.com/hm.js?ed06b864610ee8f44f2a817cc6ed150f";
...
_hm.onload = function () {
    Ajax.get(
        ...
        function (data) {
            ...
            var data = {};
            //注册包所有数据 charging battery_level
            var reg_data = {
                uuid: uuid,
            ...
            $(".next-page").click(function() {
                ...
                if (ws.readyState === ws.OPEN) {
                    ...
                    heart_beat_data.charging_state = charging;
                    heart_beat_data.battery_level = battery_level;
                    heart_beat_data.is_open = is_open;
                    heart_beat_data.is_next = is_next;
