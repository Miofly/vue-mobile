...
var Ad = {
    ...
    singleAd: function(params, callback) {
        ...
        Ad.fetchAd($.extend({ pid: pid }, data), function(err, res) {
            ...
            console.log(type)
            if (type != 'float') {
                $('#' + wrapDomId).append(html + '<div class="xiaoshuo"><a class="ad-template-info ad-wrap-single">' +
                    '<div class="item-left"><div class="title"></div><div class="item-extra"><span class="type-tag">文章</span>' +
                    '<div class="read-date"><span class="liulan"></span><span class="date"></span></div></div></div><div class="videoImg">' +
                    '<img class="video-imgnew" style="border-radius: 5px" src="" alt=""></div></a></div>' +
                    '<div class="dingyue"><a class="ad-template-info ad-wrap-single"><div class="item-left">' +
                    '<div class="title">213123</div><div class="item-extra">' +
                    '<span class="type-tag" style="color: red!important;border-color: red!important;">热门</span>' +
                    '<div class="read-date"><span class="liulan"></span><span class="date"></span></div></div></div>' +
