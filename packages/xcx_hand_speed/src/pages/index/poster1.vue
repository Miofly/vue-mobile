...
export default {
    ...
    methods: {
        ...
        creatTitle(ctx, canvasAttr) {
            ...
            ctx.setFontSize(30)
            let textY = this.drawText(ctx, title, (this.system.w - testWidth) / 2,
                (this.system.w - 2 * canvasAttr.marginLR - 2 * canvasAttr.innerLR  + 30) /
                canvasAttr.posterRatio + 2 * canvasAttr.innerLR + canvasAttr.marginTB,
                this.system.w - 2 * canvasAttr.marginLR - 2 * canvasAttr.innerLR, canvasAttr.titleLineHeight)
            ctx.draw(true)
            return textY
        },
        creatTitleTwo(ctx, canvasAttr) {
            ...
            let testWidth = metrics.width;
            ctx.setFontSize(20)
            let textY = this.drawText(ctx, title, (this.system.w - testWidth) / 2, (this.system.w - 2 * canvasAttr.marginLR - 2 * canvasAttr.innerLR - 30) / canvasAttr.posterRatio + 2 * canvasAttr.innerLR + canvasAttr.marginTB, this.system.w - 2 * canvasAttr.marginLR - 2 * canvasAttr.innerLR, canvasAttr.titleLineHeight)
            ctx.draw(true)
            return textY
        },
        /**
