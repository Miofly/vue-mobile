<template>
	<view class="padding-xl full-width-height bg"
		...
		<view class="margin-top">
			<!--海报-->
			<m-image class="fl" duration="0" :showLoading="false" :borderRadius="10" bgColorError="rgba(0, 0, 0, 1)" style="width: 48%"
			...
			<!--客服-->
			<button class="fr" style="width: 48%;" open-type="contact">
...
export default class extends Vue {
	...
	async putUserInfo (encryptedData, iv) {
        await commonPost('/mina/wx_auth/decrypt_data', { encryptedData, iv, sessionKey: this.$store.state.center.session_key, type: 2 })
	}
...
.bg1 {
	background-image:url('data:image/png;base64,');
}
</style>
