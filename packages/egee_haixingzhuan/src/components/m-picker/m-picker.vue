<template>
	<m-popup :maskCloseAble="maskCloseAble" :popup="false" :safeAreaInsetBottom="safeAreaInsetBottom" :z-index="uZIndex"
			 @close="close"
			 length="auto" mode="bottom" v-model="value">
...
<script>
    /* eslint-disable */
    import provinces from '@/common/plugin/province.js'
    import citys from '@/common/plugin/city.js'
    import areas from '@/common/plugin/area.js'
