    ...
    <view v-show="canvasShow" class="canvas-content">
        ...
        <view class="">
            ...
            <m-button :customStyle="{fontSize: '14px'}" :disabled="false" :hairLine="true" :loading="false" :plain="false"
                      ...
                      :type="['default', 'primary', 'error', 'warning', 'success'][1]" class="text-white" @tap="handleSaveCanvasImage">
            ...
            <m-button :customStyle="{fontSize: '14px'}" :disabled="false" :hairLine="true" :loading="false" :plain="false"
                      :ripple="true" :shape="['square', 'circle'][1]"
                      :size="['default', 'medium', 'mini'][1]"
                      :type="['default', 'primary', 'error', 'warning', 'success'][2]" class="text-white" @tap="handleCanvasCancel">
                <view v-if="false" class="fa text-xl fa-android margin-right-xxl" style="height: 50rpx"></view>
                取消
            </m-button>
        </view>
