<template>
	<view v-if="loading" :style="{
	 ...
	 @touchmove.stop.prevent>
		<view v-for="(item) in RectNodes" :key="$mio.mioRoot.guid()" :class="[animation ? 'skeleton-fade' : '']" :style="{
			width: item.width + 'px',
		...
		<view v-for="(item) in circleNodes" :key="$mio.mioRoot.guid()" :class="animation ? 'skeleton-fade' : ''" :style="{
			width: item.width + 'px',
			height: item.height + 'px',
			backgroundColor: elColor,
		...
		<view v-for="(item) in filletNodes" :key="$mio.mioRoot.guid()" :class="animation ? 'skeleton-fade' : ''" :style="{
			width: item.width + 'px',
			height: item.height + 'px',
			backgroundColor: elColor,
